...
namespace VolumetricShading
{
    public static class ModSettings
    {
        ...
        public static bool FasterShadowsEnabled
        {
            get => ClientSettings.Inst.GetBoolSetting("volumetricshading_fasterShadows");
            set => ClientSettings.Inst.Bool["volumetricshading_fasterShadows"] = value;
        }
